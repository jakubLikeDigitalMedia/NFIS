...
<div id="previous-employment">
    <div class="add-block" >
        <div class="new-block hide">
            ...
            <div class="form-input">
                <select class="form-dropdown" style="width:150px" id="location" name="prev:<?= PREV_PREFIX.EMPL_TABLE.SEP.EMPL_LOCATION ?>[]">
            ...
            <ul>
                <li class="form-line" id="id_13">
                    ...
                    <div id="cid_13" class="form-input">
                        <input type="text" class=" form-textbox" data-type="input-textbox" id="street" name="<?= PREV_PREFIX.OA_TABLE.SEP.OA_STREET ?>[]" size="40" value="<?= get_field_value(OA_TABLE.SEP.OA_STREET, $userInputs, 'Enter your house number and street') ?>" />
                    </div>
                </li>
                <li class="form-line" id="id_14">
                    ...
                    <div id="cid_14" class="form-input">
                        <input type="text" class=" form-textbox" data-type="input-textbox" id="postcode" name="<?= PREV_PREFIX.OA_TABLE.SEP.OA_POSTCODE ?>[]" size="20" value="<?= get_field_value(OA_TABLE.SEP.OA_POSTCODE, $userInputs, 'Enter postcode')?>" maxlength="12" />
                    </div>
                </li>
                <li class="form-line" id="id_15">
                    ...
                    <div id="cid_15" class="form-input">
                        <input type="text" class=" form-textbox" data-type="input-textbox" id="city" name="<?= PREV_PREFIX.OA_TABLE.SEP.OA_CITY ?>[]" size="40" value="<?= get_field_value(OA_TABLE.SEP.OA_CITY, $userInputs, 'Enter city')?>" />
                    </div>
                </li>
                <li class="form-line" id="id_16">
                    ...
                    <div id="cid_16" class="form-input">
                        <input type="text" class=" form-textbox" data-type="input-textbox" id="county" name="<?= PREV_PREFIX.PREV_PREFIX.OA_TABLE.SEP.OA_COUNTY ?>[]" size="40" value="<?= get_field_value(OA_TABLE.SEP.OA_COUNTY, $userInputs, 'Enter county')?>" />
                    </div>
                </li>
            </ul>
        </div>
